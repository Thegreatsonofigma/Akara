...
export function Solution() {
  return (
    <section className="relative border-t border-hairline bg-surface py-20 sm:py-28">
      <Container>
        <SectionHeader
          eyebrow="The fix"
        ...
        />
        <Reveal y={32}>
          <div className="relative overflow-hidden rounded-[2rem] border border-hairline bg-black p-6 sm:p-12">
