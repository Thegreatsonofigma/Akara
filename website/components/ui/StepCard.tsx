...
export function StepCard({
  ...
  return (
    <Reveal delay={delay} className={cn("h-full", className)}>
      <div className="flex h-full flex-col gap-3.5 rounded-2xl border border-hairline bg-surface-2 p-6 transition-all duration-300 hover:border-brand/35">
        <span
          aria-hidden="true"
          className="flex size-10 items-center justify-center rounded-xl border border-brand/20 bg-brand/[0.08] font-numbers text-lg tracking-wider text-brand"
        >
          {number}
        </span>
