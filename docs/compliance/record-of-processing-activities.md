...
| Stellar integrity anchoring and verifiable reputation | Detect later alteration of completed trade and reputation records and provide independently timestamped commitments. | Verified users who complete or dispute trades. | Private Akara snapshot: opaque HMAC subjects, trade-state metadata, receipt digest, dispute-text digest, aggregate reputation metrics, random salt. Public Stellar record: one Merkle root, dedicated Akara public account, transaction hash, ledger time. | Existing Akara trade, evidence, dispute, and reputation records. | Legitimate interests in fraud prevention, integrity, accountability, and dispute evidence. Confirm in the final DPIA and privacy notice. | Akara server, Supabase, Stellar public network, Horizon endpoint. | Public ledger receives only the batched Merkle root; authorised admins can inspect the private source snapshot. | Public ledger commitment is permanent. Private snapshot follows the source trade or dispute retention rule. | Yes. Stellar validators and data services may operate globally. | No direct identifiers or UUIDs on-chain, salted commitments, HMAC subjects, Merkle batching, dedicated low-balance signer, fee ceiling, HTTPS, append-only database triggers, testnet-first activation. | Engineering / Privacy Lead. | Obtain DPCO or privacy-counsel approval of lawful basis and user notice before mainnet. |
